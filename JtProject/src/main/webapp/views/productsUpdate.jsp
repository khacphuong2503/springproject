...
<body>
	...
	<div class="jumbotron container border border-info">
		<h3>Cập nhật sản phẩm hiện có</h3>
		<form action="updateData" method="post">
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="weight">Số lượng hiện tại</label> 
				...
				<div class="form-group">
						...
						<textarea class="form-control border border-success" rows="4" name="description" placeholder="Chi tiết sản phẩm" value= "${ pdescription }"></textarea>
					</div>
					<p>Hình ảnh</p>
