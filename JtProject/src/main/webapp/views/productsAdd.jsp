		...
		<form action="sendData" method="post">
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="weight">Số lượng còn</label> 
				...
				<div class="form-group">
						...
						<textarea class="form-control border border-warning" rows="4" name="description" placeholder="Chi tiết sản phẩm" value= "no product details"></textarea>
					</div>
					<p>Product Image</p>
					<div class="custom-file">
						...
						<label class="custom-file-label border border-warning" for="productImage">Chọn file từ thiết bị</label>
