    ...
    <div class="container-fluid">
        ...
        <h4>Xin chào ${ username } </h4>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" sec:authorize="isAuthenticated()" href="logout">Đăng xuất</a>
                </li>
                <li class="nav-item active">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="profileDisplay" >Hồ sơ</a>
                </li>
            </ul>
...
<header>
	<div class="overlay">
<center><h2>Điền thông tin của bạn.</h2></center>
<style>
h2 {
...
<form action="https://formcarry.com/s/Pq3xf4Lbabh" method="POST">
        <table class="tab2" width="45%" align="center" bgcolor="# 00BFFF">
            <tr>
                <td><br></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" colspan="2">
                    <br><button type="submit">
                        <font size="5" face="arial">Gửi</font>
                    </button>
                </td>
            </tr>
            <tr>
